...
| Skill Domain | Tools & Techniques |
|---|---|
| **SIEM & Monitoring** | Splunk, Elastic Stack (ELK), Log Analysis, Threat Hunting |
| **Incident Response** | EDR, Malware Analysis, Digital Forensics, IR Planning |
| **Web App Security** | Burp Suite, OWASP ZAP, SQLi, XSS, CSRF, JWT, OAuth2, GraphQL |
| **Penetration Testing** | Metasploit, Nmap, SQLMap, Wireshark, Priv-Esc, Lateral Movement |
| **Scripting & Automation** | Python, Bash, PowerShell, SQL |
| **Operating Systems** | Kali Linux, Linux CLI, Windows Server, pfSense, VMware/VirtualBox |
...
[PortSwigger]  120+ labs completed
               SQLi · XSS · CSRF · IDOR · JWT · OAuth2 · GraphQL · Web Cache Poisoning

[HackTheBox]   20+ machines solved
               Active Directory · Privilege Escalation · Lateral Movement · Post-Exploitation

[OSCP Prep]    Active — custom Metasploit env · C# stagers · AD attack chains
```
